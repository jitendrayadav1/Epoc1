...
public class Demo_ExtentReport extends TestListenerAdapter{
	...
	public void onTestSuccess(ITestResult result) {
		...
		try {
			...
			case "monthPerformance":
				setResultToExcel.setOutputToExcel(1, 10, TestBase.takesScreenshot(result.getMethod().getMethodName()));
				break;
				
			case "lowAttendancePerformance":
				setResultToExcel.setOutputToExcel(2, 10, TestBase.takesScreenshot(result.getMethod().getMethodName()));
				break;
				
			case "GirdPerformance":
				setResultToExcel.setOutputToExcel(3, 10, TestBase.takesScreenshot(result.getMethod().getMethodName()));
				break;
				
			case "characteristicPerformance":
				setResultToExcel.setOutputToExcel(4, 10, TestBase.takesScreenshot(result.getMethod().getMethodName()));
				break;
				
			case "Marks_Obtained":
				setResultToExcel.setOutputToExcel(5, 10, TestBase.takesScreenshot(result.getMethod().getMethodName()));
				break;
				
			case "total_Marks":
				setResultToExcel.setOutputToExcel(6, 10, TestBase.takesScreenshot(result.getMethod().getMethodName()));
				break;
				
			case "marks_Percentage":
				setResultToExcel.setOutputToExcel(7, 10, TestBase.takesScreenshot(result.getMethod().getMethodName()));
				break;
				
			case "attendance_Percentage":
				setResultToExcel.setOutputToExcel(8, 10, TestBase.takesScreenshot(result.getMethod().getMethodName()));
				break;
				
			case "Group_Marking":
				setResultToExcel.setOutputToExcel(9, 10, TestBase.takesScreenshot(result.getMethod().getMethodName()));
				break;
	...
	public void onTestFailure(ITestResult result) {
		...
		try {
			...
			case "monthPerformance":
				setResultToExcel.setOutputToExcel(1, 10, TestBase.takesScreenshot(result.getMethod().getMethodName()));
				setResultToExcel.setOutputToExcel(1, 9, NewIssue.getKey());
				break;
				
			case "lowAttendancePerformance":
				setResultToExcel.setOutputToExcel(2, 10, TestBase.takesScreenshot(result.getMethod().getMethodName()));
				setResultToExcel.setOutputToExcel(2, 9, NewIssue.getKey());
				break;
				
			case "GirdPerformance":
				setResultToExcel.setOutputToExcel(3, 10, TestBase.takesScreenshot(result.getMethod().getMethodName()));
				setResultToExcel.setOutputToExcel(3, 9, NewIssue.getKey());
				break;
				
			case "characteristicPerformance":
				setResultToExcel.setOutputToExcel(4, 10, TestBase.takesScreenshot(result.getMethod().getMethodName()));
				setResultToExcel.setOutputToExcel(4, 9, NewIssue.getKey());
				break;
				
			case "Marks_Obtained":
				setResultToExcel.setOutputToExcel(5, 10, TestBase.takesScreenshot(result.getMethod().getMethodName()));
				setResultToExcel.setOutputToExcel(5, 9, NewIssue.getKey());
				break;
				
			case "total_Marks":
				setResultToExcel.setOutputToExcel(6, 10, TestBase.takesScreenshot(result.getMethod().getMethodName()));
				setResultToExcel.setOutputToExcel(6, 9, NewIssue.getKey());
				break;
				
			case "marks_Percentage":
				setResultToExcel.setOutputToExcel(7, 10, TestBase.takesScreenshot(result.getMethod().getMethodName()));
				setResultToExcel.setOutputToExcel(7, 9, NewIssue.getKey());
				break;
				
			case "attendance_Percentage":
				setResultToExcel.setOutputToExcel(8, 10, TestBase.takesScreenshot(result.getMethod().getMethodName()));
				setResultToExcel.setOutputToExcel(8, 9, NewIssue.getKey());
				break;
				
			case "Group_Marking":
				setResultToExcel.setOutputToExcel(9, 10, TestBase.takesScreenshot(result.getMethod().getMethodName()));
				setResultToExcel.setOutputToExcel(9, 9, NewIssue.getKey());
				break;
